...
- <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Prof. [xxx](xxx).
- <span class="fas fa-user-friends" aria-hidden="true"></span> Teaching assistants: xx, xx.
- <span class="fas fa-question" aria-hidden="true"></span> Course questions can be posted to [Piazza](xxx), or in person.  
...
The following people have contributed to the design of the course materials and website: Prof. Fanny Chevalier (2019-2020), Prof. Nathan Taback (2019), Nicole Sultanum (2019).
