...
- Professor: 
  - In-person from 1-2pm on Mondays when guest lectures are on Tuesdays (see course schedule [here](schedule.html)).
  - Virtual from 2:30-3:30pm on Mondays when guest lectures are on Mondays (Zoom link [here](https://q.utoronto.ca/courses/256475)).
...
- Lab Sessions through January 26 will be held via Zoom . The link will be provided on [Quercus](https://q.utoronto.ca/courses/256475).
