...
### _Lectures_
- Monday, 1-3pm EST
- Lectures will be held via Zoom. The link is provided [here](https://utoronto.zoom.us/j/87851358931). The password is `JSC_270`.
...
- Lab Sessions will also be held via Zoom. The link is provided [here](https://utoronto.zoom.us/j/86368512792). The password is `JSC270_Lab`
...
knitr::kable(jsc270coursegrading[1:9,])
```
