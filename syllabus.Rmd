...
- Professor: 
  - In-person from 2-3pm when guest lectures are on Tuesdays (see course schedule [here](schedule.html))
  - Virtual from 2:30-3:30pm when guest lectures are on Mondays (Zoom link [here](https://q.utoronto.ca/courses/256475))
...
### _Lectures_
- Monday, 12-2pm EST
- Lectures through January 24 will be held via Zoom. The link is provided on [Quercus](https://q.utoronto.ca/courses/256475).
...
- Lab Sessions will also be held via Zoom through January 26. The link is provided on [Quercus](https://q.utoronto.ca/courses/256475).
...
These quizzes (4) will be held throughout the course and will be completed and submitted in Quercus, under the `Assignments` tab (See this [link](https://q.utoronto.ca/courses/201532/assignments)). These assignments are to be completed individually.
