...
- <span class="fas fa-question" aria-hidden="true"></span> Questions about this course should be directed to the [Piazza discussion board](https://q.utoronto.ca/courses/298689) integrated within Quercus, which students can access by logging in with their UTORID.  One of the TAs will try to answer promptly.  Please see the Course Policies section for more detail. 
...
- Questions and Answers can be posted on the [Piazza discussion board](https://q.utoronto.ca/courses/298689).
...
You will need to sign up for a free account. Once your account is confirmed, you can enroll in this class using the course code: `NOBRE-7WWXU `. 
...
These quizzes will be held throughout the course and will be completed and submitted in [Quercus]((https://q.utoronto.ca/courses/298689)), under the `Assignments` tab. These assignments are to be completed individually.
